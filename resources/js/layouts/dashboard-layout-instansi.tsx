...
export default function DashboardLayoutInstansi({
    children,
}: {
    children: React.ReactNode;
}) {
    // Data Mock User (Sementara)
    const user = { name: 'Institution User' };
    ...
    const menuItems = [
        ...
        },
        {
            ...
            href: '/instansi/bantuan',
            icon: HiQuestionMarkCircle,
        },
        { name: 'Pengaturan', href: '/instansi/pengaturan', icon: HiCog },
    ];
